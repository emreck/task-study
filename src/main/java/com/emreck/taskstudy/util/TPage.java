...
/*Frontend kısmında datatable üzerinde kayıtlar gösterilecek ve db de kaç kayıt gösteriliyorsa o kadar kayıt geri getirilecek.
bunu implemente etmek için pagenation yapılması gerekiyor. Bu sepeble frontendin size 'i bilmesi gerekiyor.*/
...
public class TPage<T>{
    ...
    private int totalPages;//toplam kaç sayfa oluştu. (10 lu gösterdiğimde 10 sayfa 100 erli gösterdiğimde 1 sayfa gibi.)
